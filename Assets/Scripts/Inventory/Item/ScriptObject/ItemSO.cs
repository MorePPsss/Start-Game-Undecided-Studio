...
Usage��
S1��Right click on the DataScriptObject file and create a new ItemSO to freely add items that can be picked up in the game
S2��Remember to add the newly added ItemSOs to the list in the DataScriptObject file for easy management, although there are currently no calls involved
 */
